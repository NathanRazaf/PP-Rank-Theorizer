...
function ScoresInfo({ scores, onDeleteFakeScore }:
    ...
    return (
        <div className="space-y-4 m-2.5 rounded-lg flex flex-col p-4" style={{backgroundColor: "hsl(var(--base-hue),10%,20%)"}}>
            <h2
                className="text-base font-bold mb-4 self-start ml-6"
                style={{borderBottom: "2px solid hsl(var(--base-hue),100%,70%)"}}
            >Ranks</h2>
            <h3 className={`r_title relative flex items-center before:absolute before:w-[3px] before:h-[0.65em] before:mt-0 before:left-[-0px] before:rounded-full before:content-['']
                ...
                Best Performance
                <span
                    style={{backgroundColor : "hsl(var(--base-hue),10%,10%)", color: "hsl(var(--base-hue),10%,60%)"}}
